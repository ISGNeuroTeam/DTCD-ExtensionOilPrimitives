...
Plugin, which includes a set of oil primitives for [PrimitiveLibraryPanel](https://github.com/ISGNeuroTeam/DTCD-PrimitiveLibraryPanel)
...
```
tar -zxf DTCD-ExtensionOilPrimitives-*.tar.gz
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/ISGNeuroTeam/DTCD-ExtensionOilPrimitives/tags).
